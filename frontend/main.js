...
ipcMain.on('view-file', (event, collectionName) => {
    ...
    pythonProcess.on('close', (code) => {
        ...
        resultsWindow.loadFile('C://Users//Dilusha fernando//Desktop//recordmate//SDGP--SE--82//frontend//screenshots_logs.html');
        
    });
});


// Define a function to load the HTML file into the window
function loadHTMLFile() {

    const filePath ="screenshots_logs.html"
    // Load the HTML file generated by your script
